...
export default function TabelaPatrimonio(props) {
        ...
        fetch(urlBase + "/aluno14-pfsii/patrimonios", {
            ...
            .then((dados) => {
                if (dados && dados.status) {
                    props.exibirTabela(true)//aki retorna a lista atualizada
    ...
    function filtrarPatrimonios(e) {
        ...
        fetch(urlBase + "/aluno14-pfsii/patrimonios", { method: "GET" })
            .then((resposta) => {
    ...
    return (
        <Container>
            ...
            <Table striped bordered hover className="shadow-lg">
                ...
                <tbody>
                    {
                        props.ListaPatrimonio?.map((patrimonio) => {
                            return <tr key={patrimonio.id}>
                                ...
                                <td>
                                    ...
                                    <Button title="Excluir" variant="btn btn-outline-danger" onClick={() => {
                                        if (window.confirm('Confirma a exclusão desse patrimonio ? ')) {
